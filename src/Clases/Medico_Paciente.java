 ...
 * @author alany
 */
//Clase Medico_Paciente (Relación)
public class Medico_Paciente {
    ...
    // Método para Mostrar Datos de la relacion Medico_Paciente   
    public void mostrarDatosMed_Pac(JTable tabla)
    {    
        ...
        try{
            ...
            ResultSet resSet;
            resSet=st.executeQuery("SELECT * FROM Medico_Paciente");
