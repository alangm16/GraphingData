...
public class Hospitales {
    ...
    // Método para Mostrar Datos de los hospitales   
    public void mostrarDatosHospitales(JTable tabla)
    {    
        ...
        modelo.addColumn("NombreHospital");
        modelo.addColumn("Dirección");
        modelo.addColumn("AñosOperando");
        ...
        try{
            ...
            ResultSet resSet;
            resSet=st.executeQuery("SELECT * FROM Hospitales");
